    ...
    allNextBtn.click(function(){
        ...
        var curStep = $(this).closest(".setup-content"),
            curStepBtn = curStep.attr("id"),
             nextStepWizard = $('div.qq  div a[href="#' + curStepBtn + '"]').parent().next().children("a"),
            // nextStepWizard = $('div.setup-panel div a[href="#' + curStepBtn + '"]').parent().next().children("a"),
            curInputs = curStep.find("input,select,textarea[type='text']"),
            isValid = true;
        ...
        if (isValid) {if (curStepBtn == 'step-2') { $('#st3').click();}
            else if (curStepBtn == 'step-4') {$('#st5').click();}
            else if (curStepBtn == 'step-6') {$('#st7').click();}}
